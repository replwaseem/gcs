...
var MAVSDK_LOG_PROTO_PATH = __dirname + '/../MAVSDK-Proto/protos/log_files/log_files.proto';
console.log(MAVSDK_LOG_PROTO_PATH);
const LOGS_PACKAGE_DEFINITION = protoLoader.loadSync(
    MAVSDK_LOG_PROTO_PATH,
    {keepCase: true,
     longs: String,
     enums: String,
     defaults: true,
...
class MAVSDKDrone {
    ...
    constructor(){
        ...
        this.LogFiles = grpc.loadPackageDefinition(LOGS_PACKAGE_DEFINITION).mavsdk.rpc.log_files;
